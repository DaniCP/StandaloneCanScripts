...
#         print 'write says: msg:', msg
    ...
    def set_buffer(self):
        """not defined in HW firmware to kvaser leaf light,
             only for professional (FUCK!)"""
        ...
        print self.dll.canObjBufAllocate(self.handle, 0x02)#2 is periodic frame
        print self.dll.canObjBufSetPeriod(self.handle, 1, 500000)
        print self.dll.canObjBufSetMsgCount(self.handle, 1, 100)
        print self.dll.canObjBufWrite(self.handle, 1, 0x764, msg, 1, 0)
        print self.dll.canObjBufEnable(self.handle, 1)
